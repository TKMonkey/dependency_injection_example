...
// Ya que cambia la clase HttpRequester y NoDIProcessing la usa, hay que cambiar el códijgo de NoDIProcessing

export class NoDIProcessing {
  private readonly databaseProxy = new DatabaseProxy();
  private readonly httpRequester = new HttpRequester(this.databaseProxy);
...
class HttpRequester {
  private readonly databaseProxy: DatabaseProxy;

  constructor(databaseProxy: DatabaseProxy) {
